...
#: Чего в наборе нет, но есть равное по смыслу. Подставляем только там,
#: где замена не меняет сказанного: «вниз» остаётся «вниз», крестик —
#: крестиком. Ножницы, звёздочку и рукопожатие не трогаем: близкого
#: премиального нет, а подменять их «чем-нибудь похожим» — это уже
#: переписывать тексты, а не оформлять их.
ALIAS = {
    "🔁": "🔄",
    "👇": "⬇️",
    "✖️": "❌",
