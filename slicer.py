...
#: Сколько рядов получится из N частей. Тройка — одна строка: широкая
#: панорама поперёк верха профиля. Формат рабочий и самый дешёвый, с
#: него удобно пробовать.
LAYOUTS = {3: 1, 6: 2, 9: 3, 12: 4, 15: 5}
